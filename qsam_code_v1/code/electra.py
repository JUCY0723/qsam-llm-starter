...
print('ELECTRA回归 MSE:', mean_squared_error(all_labels, all_preds))
print('ELECTRA回归 MAE:', mean_absolute_error(all_labels, all_preds))
print('ELECTRA回归 R2:', r2_score(all_labels, all_preds))
print('ELECTRA回归 Pearson相关系数:', np.corrcoef(all_labels, all_preds)[0,1])

# 9. 保存结果
test_df['electra_pred_score'] = all_preds
test_df.to_csv('sentiment_test_with_electra_pred.csv', index=False, encoding='utf-8-sig')
print('ELECTRA回归结果已保存至 sentiment_test_with_electra_pred.csv')
