...
# ======== 配置区：只需要改这三个文件名 ========
PRED_CSV   = "holder_target_test_with_deepseek_pred.csv"   # DeepSeek推理结果文件
GOLD_CSV   = "holder_target_test.csv"                      # 标准标签文件
OUTPUT_CSV = "holder_eval_with_deepseek.csv"               # 输出评估结果文件
