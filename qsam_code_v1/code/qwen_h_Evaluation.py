...
# ============ 配置区 ============
PRED_CSV   = "holder_target_test_with_qwen_pred1.csv"   # 预测结果文件，改成对应的模型输出即可
GOLD_CSV   = "holder_target_test.csv"                  # gold文件（标准标签）
OUTPUT_CSV = "holder_eval_with_loose1.csv"              # 输出评估结果文件
